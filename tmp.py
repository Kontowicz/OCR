...
#
# json_file = open('models/error0_56/model_96.json', 'r')
# loaded_model_json = json_file.read()
# json_file.close()
# loaded_model = model_from_json(loaded_model_json)
# loaded_model.load_weights('models/error0_56/weight_96.h5')
...
loaded_model = model()
loaded_model.readModel('models/error_3/model.json', 'models/error_3/weight.h5')
...
for i, roi in enumerate(rois[:34]):
    ...
    implt(roi)
    img_dupa = Image.fromarray(roi)
    print(pytesseract.image_to_string(img_dupa))
    ...
    #     prediction = pytesseract.image_to_string(img_tmp)
